  ...
  return (
    ...
    <>
      <section id="parallax-header" className="outer-pro1">
        ...
        <Row className=" space container center ">
          <Col
      ...
      <section id="parallax-pro2" className="outer-pro1 ">
        ...
        <Row className="animate__animated animate__fadeIn animate__delay-3s container">
          ...
          >
            <div className=" ">
              <div className="">
                <div className="container spaceSmall normalText">
          ...
          >
            <div className=" ">
              <div className="">
                <div className='img-box-small center borderBotG'>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698469914382366/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698578811097108/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698382127628378/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                </div>
                <div className="img-area space1 container">
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698469914382366/unknown.png" alt="projectIMG" className="img-box box-3"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698578811097108/unknown.png" alt="projectIMG" className="img-box box-2"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/960698382127628378/unknown.png" alt="projectIMG" className="img-box box-1"></img>
      ...
      <section id="parallax-pro0" className="outer-pro1">
        ...
        <Row className="animate__animated animate__fadeIn animate__delay-3s  container">
            ...
            <div className=" ">
              <div className="">
                <div className="container normalText">
                  ...
                  <p className="borderBotG borderTopG spaceSmaller"> Implemented the backend for a RESTful API that exposes operations for social media data that resembles the conceptual model of Twitter
                    Built infrastructure and 10+ endpoint methods using CRUD operations.
                    Managed and set up our task list accelerating and optimizing workflow.
                    Led team to communicate and implement coding practices that reflect our given instructions.</p>
                </div>
                <div className="center spaceSmaller ">

                  <a href="https://dev.java/"><img className="img-tech " src="https://cdn.discordapp.com/attachments/709148993262977068/961690694861344839/unknown.png" alt="Java" href="#aboutme" /></a>
                  <a href="https://spring.io/"><img className="img-tech " src="https://cdn.discordapp.com/attachments/709148993262977068/961689011901055046/PngItem_1746763.png" alt="Spring" href="#aboutme" /></a>
                  <a href="https://sequelize.org/"><img className="img-tech " src="https://cdn.discordapp.com/attachments/709148993262977068/961689969175433226/unknown.png" alt="ReactJS" href="#aboutme" /></a>
                  <a href="https://git-scm.com/"><img className="img-tech " src="https://cdn.discordapp.com/attachments/709148993262977068/897947921285259264/git-logo.png" alt="GIT" href="#aboutme" /></a>
                </div>
                <div className="spaceSmall">
                  <div className=" center normalText">
                    <a href="https://github.com/fasttrackd-student-work/spring-assessment-social-media-team-2-1" target="__blank" className="link borderRoundG spacing2 animate__fadeInUpBig">Repository <i class="fab white-text fa-github"></i></a>
          ...
          >
            <div className=" ">
              <div className="">
                <div className='img-box-small center borderBotG'>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/872962866016321536/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/872963074288681020/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                  <img src="https://cdn.discordapp.com/attachments/709148993262977068/872963214541991946/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
                </div>

                <div className="img-area space container">

                <img src="https://cdn.discordapp.com/attachments/709148993262977068/961696777587793950/unknown.png" alt="projectIMG" className="img-box"></img>
        ...
        <Row className="animate__animated animate__fadeIn animate__delay-3s  container ">
          ...
          >
            <div className='img-box-small center'>
              <img src="https://cdn.discordapp.com/attachments/709148993262977068/872963637239762995/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
              <img src="https://cdn.discordapp.com/attachments/709148993262977068/872964035400830976/unknown.png" alt="projectIMG" className="mobileImg spacing2"></img>
              <img src="https://cdn.discordapp.com/attachments/709148993262977068/872963710736556042/chrome_LojRghipQe.jpg" alt="projectIMG" className="mobileImg spacing2"></img>
            </div>
            <div className=" ">
              <div className="">
                <div className="img-area spaceSmall container">
